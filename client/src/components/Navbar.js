        ...
        { 
            isLoggedIn ? (
                <ul className="nav navbar-nav ml-auto top-nav">
                    ...
                    <li className="nav-item"><Link to="/checkout"><img id='cart-img' alt="shopping cart" src='/images/money-bag.png' className="nav-link"/><span>Cart</span></Link></li>
                </ul>
            ) : (
                <ul className="nav navbar-nav ml-auto top-nav">
                    ...
                    <li className="nav-item"><Link to="/cart"><img id='cart-img' src='/images/shopping-cart.png' alt="shopping cart"className="nav-link"/><span className="cart-item_total">{cartSize}</span></Link></li>
                </ul>
        )}
        </div>
    </nav>
