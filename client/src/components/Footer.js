    ...
    return(
        <footer>
            <div className="row footer-box">
                <div className="col-xs-6 col-sm-6 col-lg-3 footer-box__logo">
                ...
                <div className="col-xs-6 col-sm-6 col-lg-6 footer-box__address">
                ...
                <div className="col-xs-6 col-sm-6 col-lg-3 footer-box__social">
